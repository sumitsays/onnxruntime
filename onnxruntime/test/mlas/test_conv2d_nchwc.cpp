...
void MlasNchwcConv2DTest::MlasConv2D(
    size_t BatchCount,
    size_t GroupCount,
...
void MlasNchwcConv2DTest::ExecuteLong() {
...
// <TypeOfTester, ShortExec, Threaded>
MlasNchwcConv2DTest* Conv2dTestFixture<MlasNchwcConv2DTest, true, false>::conv2d_tester(nullptr);
MlasNchwcConv2DTest* Conv2dTestFixture<MlasNchwcConv2DTest, true, true>::conv2d_tester(nullptr);

static bool s_registered_short =
    lsm.AddShortExcuteTests(Conv2dShortExecuteTest<MlasNchwcConv2DTest, false>::RegisterShortExecTests) &&
    GetMlasThreadPool() != nullptr &&
    lsm.AddShortExcuteTests(Conv2dShortExecuteTest<MlasNchwcConv2DTest, true>::RegisterShortExecTests);

// <TypeOfTester, ShortExec, Threaded>
MlasNchwcConv2DTest* Conv2dTestFixture<MlasNchwcConv2DTest, false, false>::conv2d_tester(nullptr);
MlasNchwcConv2DTest* Conv2dTestFixture<MlasNchwcConv2DTest, false, true>::conv2d_tester(nullptr);
static bool s_registered_long =
    lsm.AddLongExcuteTests(Conv2dLongExecuteTest<MlasNchwcConv2DTest, false>::RegisterLongExecute) &&
    GetMlasThreadPool() != nullptr &&
    lsm.AddLongExcuteTests(Conv2dLongExecuteTest<MlasNchwcConv2DTest, true>::RegisterLongExecute);

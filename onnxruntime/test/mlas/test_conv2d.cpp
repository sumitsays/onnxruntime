...
void MlasConv2DTest::MlasConv2D(
    size_t BatchCount,
    size_t GroupCount,
    size_t InputChannels,
    size_t InputHeight,
...
void MlasConv2DTest::ReferenceConv2D(
    size_t BatchCount,
    size_t GroupCount,
    size_t InputChannels,
    size_t InputHeight,
...
void MlasConv2DTest::ExecuteLong(void) {
...
MlasConv2DTest* Conv2dTestFixture<MlasConv2DTest, true, false>::conv2d_tester(nullptr);
MlasConv2DTest* Conv2dTestFixture<MlasConv2DTest, true, true>::conv2d_tester(nullptr);

static bool s_registered_short =
    lsm.AddShortExcuteTests(Conv2dShortExecuteTest<MlasConv2DTest, false>::RegisterShortExecTests) &&
    lsm.AddShortExcuteTests(Conv2dShortExecuteTest<MlasConv2DTest, true>::RegisterShortExecTests);

// <TypeOfTester, ShortExec, Threaded>
MlasConv2DTest* Conv2dTestFixture<MlasConv2DTest, false, false>::conv2d_tester(nullptr);
MlasConv2DTest* Conv2dTestFixture<MlasConv2DTest, false, true>::conv2d_tester(nullptr);
static bool s_registered_long =
    lsm.AddLongExcuteTests(Conv2dLongExecuteTest<MlasConv2DTest, false>::RegisterLongExecute) &&
    lsm.AddLongExcuteTests(Conv2dLongExecuteTest<MlasConv2DTest, true>::RegisterLongExecute);

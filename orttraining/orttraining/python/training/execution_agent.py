...
class ExecutionAgent(object):
    ...
    def __init__(self, path_or_bytes, session_options=None, providers=None, provider_options=None, is_training=True):
        ...
        self.create_execution_session(path_or_bytes, session_options, providers, provider_options)

    def create_execution_session(self, path_or_bytes, session_options, providers, provider_options):
